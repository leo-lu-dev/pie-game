...
export type PublicPuzzle = { id: string; title: string; context?: string; publishDate?: string; categories: PublicCategory[]; slices: PublicSlice[]; maxAttempts: number; state?: { attempts: number; solved: boolean; guesses: SavedGuess[]; reveal?: string[] } };
